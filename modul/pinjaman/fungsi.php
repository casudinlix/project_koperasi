...
*/
$get_data = $conn->query("SELECT RIGHT(kd_pinjaman,2) FROM tt_pinjaman ORDER BY RIGHT(kd_pinjaman,2) DESC" );
...
// MEMBUAT CUSTOM KODE BAGIAN DEPAN
 //$get_3_number_of_year . '-'; // 7 karakter custom code dari sebelah kiri
...
elseif ( $new_code >= 10 && $new_code < 100 ) :
	...
	$kd .= $year.$custom_code.$new_code; // batas data di db hannya sampai 9999 data
endif;
